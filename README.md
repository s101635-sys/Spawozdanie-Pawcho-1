...
<missing>      5 minutes ago   COPY index.html /var/www/html/ # buildkit       20.5kB    buildkit.dockerfile.v0
<missing>      5 minutes ago   RUN /bin/sh -c apt update &&     apt upgrade…   142MB     buildkit.dockerfile.v0
